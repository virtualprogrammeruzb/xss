...
def banner():
    ...
    print(  R + xb.renderText('XSS-SCAN'))
    print( G + "~#  Dasturchi: @virtual_programmer_sh ")
    print( Y + "~# Kanal: @virtual_programmers_chanel ")
banner()
...
if __name__ == '__main__':
    ...
    for opt, arg in opts:
        if opt == '-h':
            print('xss-scan.py -u <url>')
            print('xss-scan.py -c <cookie> -u <url>')
            sys.exit()
        elif opt in ("-u", "--url"):
            url = arg
            print(xira(url))
